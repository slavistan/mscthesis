...
\newcommand{\marginLeft}{20 mm}       % margin between text and left end of page
\newcommand{\marginRight}{20 mm}      % margin between text and right end of page
...
% Increse the arbitrarily limit of 10 columns in a matrix-environemtn.
% .. Latex why?
