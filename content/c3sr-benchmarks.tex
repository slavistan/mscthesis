...
\chapter{Characterization \& Benchmarks}
  ...
  \section{Relative Object Size for Fully Structured Matrices} \label{sec:rel-object-size-fully-structured}
    ...
    compressed, numerical values or structure, compresses perfectly in the above sense.
  ...
  \section{Object Size per Nonzero for Perturbed Structured Matrices} \label{sec:objsize-perturbed}
    ...
    \begin{figure}[H]
      ...
      \toccaption{Structured grid with integration path over non-contiguous nodes.}
  ...
  \section{Matrix-Vector Multiplication of Fully Structured Matrices} \label{sec:mvm-structured}
    ...
    \begin{figure}[H]
      ...
      \toccaption{Matrix-vector multiplication bandwidth benchmarks of unperturbed matrices of both families.}{Both
        multiplication schemes are displayed for all three machines. Maximum achievable bandwidth is shown in red. KNL
        performance is limited by thread synchronization overhead which causes slowdown for small grid sizes on the
    ...
    \end{figure}
     ...
     \begin{figure}[H]
       ...
       \toccaption{Matrix-vector multiplication benchmark results based on former implementation which uses TBB.}{Same
         results are shown as in the previous figure. Measurements partly exhibit large variances which is why their error
         bars were omitted. This graph is shown to highlight the difference arising for medium sized grids if the
  ...
  \section{Matrix-Vector Multiplication of Perturbed Structured Matrices} \label{sec:mvm-perturbed}
    ...
    \begin{figure}[H]
      ...
      \toccaption{Matrix-vector multiplication bandwidth benchmarks of perturbed matrices of both families.}{Both
        multiplication schemes are displayed for the Skylake machines. Maximum achievable bandwidth is shown in red.}
