...
\chapter{Characterization \& Benchmarks}
  ...
  \section{Matrix-Vector Multiplication with Fully Structured Matrices} \label{sec:mvm-structured}
    ...
    contain all data. Figure \ref{fig:mvm-perturbed-new} displays the obtained benchmark results for both families of
    matrices derived from structured grids.
    ...
    - theoretische bandbreiten sind konstant
